...
$(document).on('submit', '#edit', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('admin/pasien/api_edit/') ?>" + form_data.get(
            'id_pasien'),
        dataType: "json",
        data: form_data,
        processData: false,
...
$(document).on('submit', '#gantipassword', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('admin/pasien/api_password/') ?>" + form_data.get(
            'id_pasien'),
        dataType: "json",
        data: form_data,
        processData: false,
...
function hapuspasien(id_pasien) {
    swal({
        ...
        if (result.value) { // Only delete the data if the user clicked on the confirm button
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/pasien/api_hapus/') ?>" +
                    id_pasien,
                dataType: "json",
            }).done(function() {
                swal({
