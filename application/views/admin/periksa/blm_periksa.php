 ...
 function dalam_antrian(id_periksa) {
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/periksa/diperiksa/') ?>" + id_periksa,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
    ...
    $(document).on('submit', '#edit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/periksa/sudah_periksa/') ?>" + form_data.get('id_periksa'),
                    dataType: "json",
                    data: form_data,
                    processData: false,
                    contentType: false,
    ...
    function batal_periksa(id_periksa) {
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/periksa/batal_periksa/') ?>" + id_periksa,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
