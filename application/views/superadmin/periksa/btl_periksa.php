...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h5>Data Batal Periksa tgl <?= tgl_indo($tgl) ?></h5>
...
$(document).on('submit', '#edit', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('superadmin/periksa/api_edit/') ?>" + form_data.get(
            'id_periksa'),
        dataType: "json",
        data: form_data,
        processData: false,
...
function hapusperiksa(id_periksa) {
    swal({
        ...
        if (result.value) { // Only delete the data if the user clicked on the confirm button
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('superadmin/periksa/api_hapus/') ?>" +
                    id_periksa,
                dataType: "json",
            }).done(function() {
                swal({
